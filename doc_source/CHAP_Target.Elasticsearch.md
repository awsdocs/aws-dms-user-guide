# Using an Amazon Elasticsearch Service cluster as a target for AWS Database Migration Service<a name="CHAP_Target.Elasticsearch"></a>
...
## Migrating from a relational database table to an Amazon ES index<a name="CHAP_Target.Elasticsearch.RDBMS2Elasticsearch"></a>
...
## Prerequisites for using Amazon Elasticsearch Service as a target for AWS Database Migration Service<a name="CHAP_Target.Elasticsearch.Prerequisites"></a>
...
## Extra connection attributes when using Amazon ES as a target for AWS DMS<a name="CHAP_Target.Elasticsearch.Configuration"></a>
...
## Limitations when using Amazon Elasticsearch Service as a target for AWS Database Migration Service<a name="CHAP_Target.Elasticsearch.Limitations"></a>
...
## Target data types for Amazon Elasticsearch Service<a name="CHAP_Target.Elasticsearch.DataTypes"></a>
