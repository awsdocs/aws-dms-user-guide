...
+ [Security requirements when using SQL Server as a source for AWS Database Migration Service](#CHAP_Source.SQLServer.Security)
...
## Security requirements when using SQL Server as a source for AWS Database Migration Service<a name="CHAP_Source.SQLServer.Security"></a>
